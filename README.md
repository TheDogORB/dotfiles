...
- `./icons` - generated icons via `./src/generate_new_bat_icons.py` available in [original repo](https://github.com/HoroTW/RazerBatteryTray/)/[me custom python file](https://github.com/TheDogORB/GenerateNewBatteryIcons)
- `./src`
